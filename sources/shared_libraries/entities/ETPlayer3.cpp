...
#include <iostream>
#include "shared_libraries/entities/ETPlayer3.hpp"

FF::ETPlayer3::ETPlayer3() : APlayer(EEntityType::PLAYER3), _direction(EMoveType::FORWARD)
{
    init();
}

void        FF::ETPlayer3::init()
{
    reinterpret_cast<CPosition*>(this->getComponent("CPosition"))->setXY(2, 7);
...
FF::CPosition       FF::ETPlayer3::move()
{
...
void            FF::ETPlayer3::killSomeone(EEntityType type)
{
